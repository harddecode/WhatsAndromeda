...
Meda.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Meda.addCommand({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
