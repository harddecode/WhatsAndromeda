...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Meda.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Meda.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
